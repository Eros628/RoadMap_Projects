...
function ResultModal({user, quizItems, result, isOpen, setIsOpen}){
                    ...
                    {quizItems.map((question, index)=>{
                        return (
                            <React.Fragment key={index}>
                                ...
                                <div className="user-answer results-data"><p>{user.answers[index]}</p></div>
                                <div className="correct-answer results-data" >
                                    <p>{result.correctAnswer[index]}</p>
